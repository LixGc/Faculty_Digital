        ...
        <div class="min-h-screen bg-white-50 flex flex-col justify-center py-12 px-6 lg:px-8">
            <div class="sm:mx-auto sm:w-full sm:max-w-md">
                <div class="w-96 p-6 shadow-lg bg-white rounded-md">
                    ...
                    <form id="signup-form" class="mb-0 space-y-6 mt-6" action="#">
                        <div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input id="password-signup" name="password" type="password" required autoComplete="password"
                                    class="border w-full text-base px-2 py-1 focus:outline-none focus:ring-0 focus:border-gray-500" />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input id="password-signup" name="password2" type="password" required
                        ...
                        <div>
                            <a class="block text-sm font-medium text-blue-700">
